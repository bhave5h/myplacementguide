...
export function Hero() {
  return (
    <section className="bg-[var(--color-canvas)] overflow-hidden relative p-5 lg:pt-20 lg:pb-32">
      <div 
      className='bg-blue-100 rounded-xl border-4 border-black/10 pt-10'
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start gap-4">
            <SplitText
              ...
              as="h1"
              className="text-balance font-display text-3xl md:text-5xl font-medium leading-[1.05] text-[var(--color-ink)] m-0"
              by="word"
              staggerDelay={0.07}
            />

            <ScrollReveal delay={0.55}>
              <p className="font-body text-[18px] font-bold leading-[1.55] text-black/80 m-0 text-balance">
            ...
            <ScrollReveal delay={0.75}>
              ...
              <p className="font-body text-[18px] mt-1 font-normal leading-[1.55] text-[var(--color-charcoal)] max-w-[540px] m-0 text-balance">
